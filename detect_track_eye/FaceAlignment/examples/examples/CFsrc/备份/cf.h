...
public:
    ...
    */
    ...
    CF_Tracker() 
	{
		...
		p_padding = 6.5; // 6.5;// 6.5(for"456"); fhog
		p_output_sigma_factor = 0.05;//0.05
		//p_output_sigma;
		p_kernel_sigma = 0.4;    //def = 0.4
		p_lambda = 1e-4;         //regularization in learning step 1e-4
		p_interp_factor = 0.09;// 0.09;  //linear interpolation factor for adaptation 
